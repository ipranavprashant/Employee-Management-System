...
int main()
{
    cout << "\n**This Program is made by Pranav Prashant, BTech Computer Science and Engineering at National Institute of Technology Calicut as the major project under the training cum intership program of the Externsclub internship program(October-December Batch)-2022**" << endl;
